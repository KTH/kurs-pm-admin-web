...
class AdminPage extends Component {
  ...
  handleUploadFile = async (id, file, e) => {
  ...
  sendRequest = (id, file, e) => {
    ...
    return new Promise((resolve, reject) => {
      ...
      req.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
          ...
          thisInstance.setState({
            ...
            alertSuccess:
              i18n.messages[thisInstance.props.routerStore.language].messages.alert_uploaded_file,
            notValid: [],
            alertError: ''
          })
        }
      ...
      req.open(
        ...
        }${this.props.routerStore.activeSemester}/${this.props.routerStore.courseCode}/${
          this.state.rounds
        }`
      )
      req.send(formData)
  ...
  handleBack = (event) => {
    ...
    if (this.state.progress === 'edit') {
      this.props.history.push(
        routerStore.browserConfig.proxyPrefixPath.uri + '/' + routerStore.courseCode
      )
            ...
            <div>
              ...
              {routerStore.newMemoList.length > 0 && this.state.isPreviewMode ? (
                <div>
                  ...
                  >
                    {translate.link_pm}:{' '}
                    {getDateFormat(this.state.pdfMemoDate, routerStore.language)}
                  </a>
                </div>
              ) : (
                ''
                      ...
                      <Row className="form-group">
                        <Col sm="6" className="col-form">
                          ...
                          <UpLoad
                            id="pm"
                            key="pm"
                            handleUpload={() => this.handleUploadFile(this)}
