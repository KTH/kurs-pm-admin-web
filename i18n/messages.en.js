    ...
    pagesProgressBar: [
      {
        ...
        intro:
          'Start by selecting the semester and course offering for the course memo to be published/changed (step 1 of 3). Then, in the next step (2 out of 3), you will upload the course memo as a PDF. Finally, in the last step (3 out of 3), you will review your course memo and publish it on \u201CPrepare and take course/Course memo\u201D. If there is a previously published course memo, your course memo will be published as a new version.',
      },
      {
